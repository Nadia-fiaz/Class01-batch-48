...
// task . 3 input balance , min balance , max balance 

function creditScore (balance:number, minBalance:number, maxBalance:number)
{ 
    balance = 340
    minBalance = 300
    maxBalance = 150
...
console.log ('fruit'[3])
// arrays funtions: add remove
// built in functions type script 
